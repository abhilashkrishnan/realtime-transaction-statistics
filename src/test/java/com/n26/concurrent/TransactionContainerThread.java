...
public class TransactionContainerThread implements Runnable {
	private int i;
	private TransactionContainer transactionContainer;
	private CountDownLatch latch;
	private long timestamp;
	
	public TransactionContainerThread(int i, long timestamp, TransactionContainer transactionContainer, CountDownLatch latch) {
		this.i = i;
